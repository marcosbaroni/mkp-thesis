...
\headerbox{The Problem (MKP)}{name=mkp,column=0,row=0}{\input{texs/mkp.tex} }
\headerbox{The Meta-heuristic (SCE)}{name=sce,column=0,below=mkp}{\input{texs/sce.tex} }
\headerbox{Results}{name=results,column=2,span=2,row=0}{\input{texs/results.tex} }
\headerbox{The Core Concept for MKP}{name=scemkp,column=1,span=1,row=0}{\lipsum[1-2] }
\headerbox{The SCE for MKP}{name=scemkp,column=1,span=1,row=0,above=bottom}{\input{texs/sce-mkp.tex} }
\headerbox{Experimental Setup}{name=setup,column=2,row=0,below=results}{\input{texs/setup.tex} }
\headerbox{Conclusions}{name=conclusions,column=3,below=results}{\input{texs/conclusions.tex} }
\headerbox{Future Remarks}{name=future,column=3,below=conclusions}{\input{texs/future.tex} }
