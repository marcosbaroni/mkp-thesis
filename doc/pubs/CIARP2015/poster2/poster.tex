...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    \newcommand{\colouredcircle}{%
	  ...
	  \headerbox{The Problem (MKP)}{name=problem,column=0,row=0}{
	\input{texs/mkp.tex}
 }

 \headerbox{The Meta-heuristic (SCE)}{name=contribution,column=0,below=problem}{
	\input{texs/sce.tex}
}

\headerbox{The SCE for MKP}{name=results,column=1,span=2,row=0}{
