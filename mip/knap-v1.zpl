...
param duration := read "knap.dat" as "1n" use 1 comment "#";

#Number of actions
param actions := read "knap.dat" as "1n" skip 1 use 1 comment "#";

#Number of budgets
param costs := read "knap.dat" as "1n" skip 2 use 1 comment "#";

#Minimum acceptable rate of return
param rate := read "knap.dat" as "1n" skip 3 use 1 comment "#";
